...
public class SyncObtainInfoLegal extends ContentProvider {

    private static final int COUNT_TASKS = 1;
    private static final int USER_DB = 2;
    private static final int TASKS = 3;
    private static final int RESP_SEG = 4;
    private static final int RESP = 5;
    private static final int PENDING_DB = 6;
    private static final UriMatcher uriMatcher;

    static {
        uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        uriMatcher.addURI("com.mx.pendulum.olinlegal.ObtainInfo.contentproviders", "count/tasks", COUNT_TASKS);
        uriMatcher.addURI("com.mx.pendulum.olinlegal.ObtainInfo.contentproviders", "db/user", USER_DB);
        uriMatcher.addURI("com.mx.pendulum.olinlegal.ObtainInfo.contentproviders", "tasks", TASKS);
        uriMatcher.addURI("com.mx.pendulum.olinlegal.ObtainInfo.contentproviders", "responsable/seg", RESP_SEG);
        uriMatcher.addURI("com.mx.pendulum.olinlegal.ObtainInfo.contentproviders", "responsable", RESP);
        uriMatcher.addURI("com.mx.pendulum.olinlegal.ObtainInfo.contentproviders", "db/pending", PENDING_DB);
    }
