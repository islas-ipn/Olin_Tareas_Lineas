...
public class ViewDate_stskt_end extends ParentViewMain {


    public ViewDate_stskt_end(Context context, Fragment fragment, DynamicFormAdapter adapter) {
    ...
    public View getView(int position, View convertView, Questions question) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(getContext(), R.layout.row_dynamic_form_date_stskt_end, null);
...
//        setAddVisible(holder, super.setRespText(question.getAnswer(), holder.tvAnswer,false));
            ...
            holder.rlAnswerEnd.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(final View v) {
                    ...
                    if (holder.tvAnswer.getTag() == null) {
                        ...
                        Toast.makeText(getContext(), "Primero selecciona la fecha de inicio", Toast.LENGTH_SHORT).show();
                        return;
                    }
    ...
    private void setAddVisibleStart(DynamicViewHolder holder, boolean added) {
        if (holder.ivDelete == null) return;
        if (added) {
    ...
    private void setAddVisibleEnd(DynamicViewHolder holder, boolean added) {
        if (holder.ivDelete2 == null) return;
        if (added) {
