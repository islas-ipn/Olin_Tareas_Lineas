...
public class GalleryTakePhotoAdapter extends RecyclerView.Adapter<GalleryTakePhotoAdapter.ViewHolder> implements ItemTouchHelperAdapter {
    ...
    public GalleryTakePhotoAdapter(Context context, OnStartDragListener dragStartListener, ArrayList<String> items, boolean isGrid) {
