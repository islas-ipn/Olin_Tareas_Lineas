...
public class SepoMuniAdapter extends ArrayAdapter<SepoMuni> {

    private List<SepoMuni> items;

    public SepoMuniAdapter(Context context, List<SepoMuni> items) {
    ...
    @Override
    public SepoMuni getItem(int position) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        ...
        SepoMuni currentItem = getItem(position);
        if (currentItem != null) {
