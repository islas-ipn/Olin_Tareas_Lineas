...
public class ViewTime extends ParentViewMain {


    public ViewTime(Context context, Fragment fragment, DynamicFormAdapter adapter) {
    ...
    public View getView(int position, View convertView, Questions question) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(getContext(), R.layout.row_dynamic_form_time, null);
